                            ...
                            <form action="{{ route('user.create') }}" method="POST" class="form">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input required maxlength="20" type="text" id="first-name-column"
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input pattern="(\+84|0)\d{9,10}" maxlength="10" minlength="10" required
                                    ...
                                    <div class="col-md col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea required name="address" maxlength="255" class="form-control"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input required maxlength="20" type="text" id="last-name-column"

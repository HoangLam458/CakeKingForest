...
<title>Cake KingForest - Thống kê</title>
                        ...
                        <div class="row">
                                ...
                                <div class="collapse multi-collapse" id="multiCollapseExample1">
                                    <div class="card card-body">
                                        <div class="alert alert-info">
                                            <h5 class="card-title">Đơn chờ duyệt <span
                                                    style="color:#ff0000; font-size:20px"> {{ $choduyet }}</span></h5>
                            ...
                            <div class="col">
                                <div class="collapse multi-collapse" id="multiCollapseExample2">
                                    <div class="card card-body">
                                        <div class="alert alert-info">
                                            <h5 class="card-title">Đơn đã thanh toán <span
                                                    style="color:#ff0000; font-size:20px"> {{ $thanhtoan }}</span></h5>
                                            @foreach ($hoadonall as $hoadon)

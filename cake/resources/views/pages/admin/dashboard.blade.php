...
<title>Cake King Forest - Thống kê</title>
...
@section('content')
    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 poi" data-toggle="collapse" data-target=".multi-collapse"
                                        ...
                                        <div class="alert alert-info">
                                            ...
                                            @foreach ($hoadonall as $hoadon)
                                                @if ($hoadon->trangthai == 1 && $hoadon->phuongthucthanhtoan == 'MoMo')
                                                    <a href="{{ route('invoice.detail', $hoadon->id) }}"><span
                                                            class="hd"> Hóa
                                                            đơn {{ $hoadon->mahd }} đã đặt hàng và thanh toán thành công
                                                            bằng
                                                            MoMo</span></a><br>
                                                @elseif($hoadon->trangthai == 1 && $hoadon->phuongthucthanhtoan == 'VnPay')
                                                    <a href="{{ route('invoice.detail', $hoadon->id) }}"><span
                                                            class="hd">Hóa
                                                            đơn {{ $hoadon->mahd }} đã đặt hàng và thanh toán thành công
                                                            bằng
                    ...
                    <div class="card-header">
                        ...
                        <form action="{{ route('filter_by_date') }}" method="POST" class="form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <button type="submit" style="margin-top: 14;" class="btn btn-primary ">
                                        Lọc kết quả
                                    </button>
                                </div>
                        </form>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card ">
                ...
                <div class="card-body ">
                    <div id="bar-example" class="" style="height: 400px;"></div>
                </div>
            </div>
        </div>
    </div>

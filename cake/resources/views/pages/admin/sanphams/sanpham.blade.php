                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-bold-500">
                                        <img width="150px" height="100px" src="{{asset('/images/'.$item->hinhanh)}}" alt="">
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <div class="modal text-left" id="animation-{{ $item->id }}" tabindex="-1"
                                                aria-labelledby="myModalLabel6" style="display: none;"
                                                aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="alert bg-rgba-success" role="alert">
                                                                This employee will be temporarily removed. <span
                                                                    class="font-weight-bold">Are you sure?</span>
                                                            </div>
                                                        </div>

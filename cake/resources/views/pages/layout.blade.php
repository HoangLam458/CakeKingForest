                ...
                <div class="col-lg-12 d-block">
                    ...
                    <div class="row d-flex">
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            ...
                            <span class="text">+84 348 575 810</span>
                        </div>
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            <div class="icon mr-2 d-flex justify-content-center align-items-center"><span
                        ...
                        <div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right ">
                            <a href="https://www.facebook.com/7sep.02/" type="button" class="btn btn-primary">
                                ...
                                <a target="_blank"  href="https://www.facebook.com/7sep.02/"><span class="text" style="font-size: 11px">
                                    Huỳnh Ngọc Hào
                                </span></a>
                                
                             
                            </a>
                            <a href="https://www.facebook.com/profile.php?id=100015327900624" type="button" class="btn btn-primary">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-facebook" viewBox="0 0 16 16">
                                    <path
                                        d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                                </svg>
                                <a target="_blank"  href="https://www.facebook.com/profile.php?id=100015327900624"><span class="text" style="font-size: 11px">
                                   Hoàng Lâm    
                                </span></a>
                            </a>
                        </div>
            ...
            <div class="row mb-5">
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        <h2 class="ftco-heading-2">Cake King Forest</h2>
                        <p>Cửa hàng bán bánh kem Cake King Forest là một địa chỉ uy tín và chất lượng cho những ai yêu thích bánh kem ngon và đẹp.
                             Cửa hàng chúng tôi có nhiều loại bánh kem đa dạng và phong phú, từ bánh kem sinh nhật,
                              bánh kem cưới, bánh kem trái cây, cho đến bánh kem sô cô la, bánh kem phô mai và nhiều hơn nữa.
                               Cửa hàng chúng tôi cũng nhận đặt bánh kem theo yêu cầu của khách hàng,
                                với mức giá hợp lý và thời gian giao hàng nhanh chóng.
                                Hãy đến với cửa hàng bán bánh kem Cake King Forest để thưởng thức những chiếc bánh kem tuyệt vời nhất!</p>
                    </div>
                </div>
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        <h2 class="ftco-heading-2">Thông tin liên lạc</h2>
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="icon icon-map-marker"></span><span class="text">65 Huỳnh Thúc Kháng, Phường Bến Nghé, Quận 1, Thành phố Hồ Chí Minh</span></li>
                                <li><span class="icon icon-phone"></span><span class="text">+84
                                            348 575 810</span></li>
                                <li><span class="icon icon-envelope"></span><span
                                            class="text">cakekingforest@gmail.com</span></li>
                            </ul>
                        </div>
                    </div>
                </div>

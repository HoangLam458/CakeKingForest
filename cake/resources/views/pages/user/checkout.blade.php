                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md col-12">
                            <div class="form-group">
                                ...
                                <input value="" pattern="(\+84|0)\d{9,10}" maxlength="10" minlength="10" required
                                    type="text" id="phone" class="form-control" name="sdtkhachhang">
                            </div>
                        </div>
                        <div class="col-md col-12">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                @if (auth()->user() == null)
                    <div class="modal-body">
                        ...
                        <div class="col-md col-12">
                            <div class="form-group">
                                <label class="mb-2" for="city-column">Số điện thoại</label>
                                <input value="" pattern="(\+84|0)\d{9,10}" maxlength="10" minlength="10"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="redirect" class="btn btn-primary" onclick="return check()">Xác
                        nhận</button>
                </div>
            </div>
        </div>
...
<form action="{{ route('momoATM') }}" method="POST" class="form" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="Modal2" tabindex="-1" role="dialog" aria-labelledby="ModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLabel">Thông tin giao hàng ATM</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
<form action="{{ route('VNPay') }}" method="POST" class="form" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="Modal3" tabindex="-1" role="dialog" aria-labelledby="ModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLabel">Thông tin giao hàng VNP</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                @endif
                <div class="modal-footer">
                    <input name="total_vnpay" value="{{ $total }}" hidden>
                    <button type="submit" name="redirect" class="btn btn-primary" onclick="return check()">Xác
                        nhận</button>
                </div>
            </div>

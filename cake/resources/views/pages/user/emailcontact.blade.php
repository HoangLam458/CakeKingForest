                                                                                ...
                                                                                <table border='0' cellpadding='0'
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align='left'>
                                                                                            ...
                                                                                            <span
                                                                                                style="font-size:20px; font-weight:600;">CAKE
                                                                                                KING FOREST</span>
                                                ...
                                                <table border='0' cellpadding='0' cellspacing='0' role='presentation'
                                                    ...
                                                    <tr>
                                                        <td align='center'
                                                            style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                                            <div
                                                                style='color:#4d4d4d;font-family:Oxygen, Helvetica neue, sans-serif;font-size:15px;font-weight:700;line-height:37px;text-align:left;'>
                                                                Họ tên khách hàng: {{  $lienhe['hoten'] }}
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td align='center'
                                                            style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                                            <div
                                                                style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:15px;font-weight:700;line-height:21px;text-align:left;'>
                                                                Nội dung liên hệ:
                                                                {{  $lienhe['noidung'] }}
                                                            </div>
                                                        </td>
                                                ...
                                                <table border='0' cellpadding='0' cellspacing='0' role='presentation'
                                                    ...
                                                    <tr>
                                                        <td align='center'
                                                            ...
                                                            <div
                                                                style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;font-style:bold;font-weight:700;line-height:21px;text-align:center;'>
                                                                @2023 CKF Inc
                                                            </div>
                                                        </td>
                                                    </tr>
